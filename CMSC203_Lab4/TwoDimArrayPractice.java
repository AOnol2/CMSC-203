 ...
 * Lab #4
 * Description: (Write a program dealing with a 4-row, 20-column, two-dimensional array of integers)
 * Due: 3/4/2024
   ...
   */
   ...
   public void startActivity( int act ){
     ...
     case( 3 ):
       ...
       try{
         answer = JOptionPane.showInputDialog( null, "Please enter a column number between 0 & 19" );
         if ( answer != null ){
   ...
   String displayMessageMin = "In column " + columnSelected + ", you found a minimum value of ";
     ...
     case( 4 ):
      while ( !goodInput || key < 50 || key > 80 ){
    	  try{
         answer = JOptionPane.showInputDialog( null, "Please enter a value between 50 & 80" );
         if ( answer != null ){
           key = Integer.parseInt( answer );
           goodInput = true;
         }
